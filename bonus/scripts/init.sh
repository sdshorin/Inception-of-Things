...
#k3d cluster create mycluster --port 80:80@loadbalancer --port 443:443@loadbalancer --port 4222:22@loadbalancer --k3s-arg "--disable=traefik@server:0" --k3s-arg "--disable=servicelb@server:0"
